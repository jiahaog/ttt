 ...
 */
function minimax(grid, currentPlayer, activePlayer, depth) {
    var topLevel = arguments.length <= 4 || arguments[4] === undefined ? false : arguments[4];

    var gameStateScore = score(grid, activePlayer, depth);
    if (gameStateScore !== 0) {
        // game over
    ...
    var possibleMoves = getPossibleMoves(grid);
    var correspondingScores = possibleMoves.map(function (move) {
        var newGridState = makeMove(grid, move, currentPlayer);
    ...
    if (currentPlayer === activePlayer) {
        ...
        result = (_Math = Math).max.apply(_Math, _toConsumableArray(correspondingScores));
    } else {
        var _Math2;

        result = (_Math2 = Math).min.apply(_Math2, _toConsumableArray(correspondingScores));
    }

    if (topLevel) {
        var moveIndexToMake = correspondingScores.indexOf(result);
...
var Board = (function () {
    ...
    function Board() {
        var initGrid = arguments.length <= 0 || arguments[0] === undefined ? emptyGrid : arguments[0];
...
var TicTacToe = (function () {
    ...
    _createClass(TicTacToe, [{
        key: 'registerPlayers',
        value: function registerPlayers(player0, player1) {
...
var _tictactoe = require('./board/tictactoe');

var _tictactoe2 = _interopRequireDefault(_tictactoe);

var _perfectPlayer = require('./players/perfectPlayer');
...
var _bestMove = require('./../board/bestMove');
...
var Player = (function () {
    ...
    _createClass(Player, [{
        ...
        key: "notifyBoardChanged",
        value: function notifyBoardChanged(grid) {
        ...
        key: "notifyTurn",
        value: function notifyTurn(grid) {
        ...
        key: "notifyGameOver",
        value: function notifyGameOver(winner) {
        ...
        key: "onBoardChange",
        value: function onBoardChange(callback) {
            this.boardChangedCallback = callback;
        }
    }, {
        key: "onMyTurn",
        value: function onMyTurn(callback) {
...
var GameGrid = _react2.default.createClass({
    ...
    choosePlayer: function choosePlayer(event) {
        ...
        var aiPlayer = new PerfectPlayer(game, 'AI-Player');

        var clientPlayer = new Player(game, 'You');
        clientPlayer.onBoardChange(function (grid) {
            _this.setState({
                gameGrid: grid
            });
        });
        ...
        clientPlayer.onGameOver(function (winner) {
...
_reactDom2.default.render(_react2.default.createElement(GameGrid, null), document.getElementById('game-react-container'));

function parseGameCellId(id) {
    var splitted = id.split('-');
    return [splitted[splitted.length - 2], splitted[splitted.length - 1]].map(function (value) {
